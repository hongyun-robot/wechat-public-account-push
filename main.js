...
const main = async () => {
    ...
    const wxTemplateParams = [
        { name: toLowerLine('date'), value: `${selfDayjs().format('YYYY-MM-DD HH:mm:ss')} ${week_list[selfDayjs().format('d')]}`, color: getColor() },
        ...
        { name: toLowerLine('loveDay'), value: loveDay, color: '#FF0000' },
